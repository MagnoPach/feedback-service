...
exports.routes.post('/feedbacks', async (req, res) => {
    ...
    const nodemailerMailApdater = new nodemailer_mail_adapter_1.NodemailerMailApdater();
    const submitFeedbackUseCase = new submit_feedback_use_case_1.SubmitFeedbackUseCase(prismaFeedbacksRepository, nodemailerMailApdater);
